...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="{{route('show_item_inventory')}}">Inventory View</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container-xxl">
            <h1 class="display-6">Admin Inventory</h1>
            <h6>Add item <a href="{{route('add')}}">here</a></h6>
            <!-- Table display -->

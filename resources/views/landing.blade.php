...
<body>
    ...
    <!-- Page -->
    <div class="container-xxl d-flex flex-column justify-content-center align-items-center" style="height: calc(100vh - 56px)">
        <h1 class="display-1 text-center">Inventory</h1>
        <h1 class="display-6 text-center">E-Commerce Solutions</h1>
        <p>*create category manual dari db*</p>
    </div>
    <!-- Bootstrap -->
